        ...
        <div class="container">
                ...
                <ul class="navbar-nav navbar-nav-hover justify-content-center">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg" aria-labelledby="supportDropdown">
                            <div class="col-auto px-0">
                                <div class="list-group list-group-flush">
                                    <a href="${path}/search/searchList.do" class="list-group-item list-group-item-action d-flex align-items-center p-0 py-3 px-lg-4">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg" aria-labelledby="supportDropdown">
                            <div class="col-auto px-0">
                                <div class="list-group list-group-flush">
                                    <a href="${path}/board_trade/tradeList.do" class="list-group-item list-group-item-action d-flex align-items-center p-0 py-3 px-lg-4">
                                        <span class="icon icon-md icon-secondary"><i class="fas fa-file-alt"></i></span>
                                        <div class="ml-4">
                                            <span class="text-dark d-block">중고거래 게시판<span class="badge badge-sm badge-secondary ml-2"></span></span>
                                        </div>
                                    </a>
                                    <a href="${path}/board/boardList.do" class="list-group-item list-group-item-action d-flex align-items-center p-0 py-3 px-lg-4">
                                        <span class="icon icon-md icon-primary"><i class="fas fa-file-alt"></i></span>
                                        <div class="ml-4">
            ...
            <c:if test="${loginMember == null}">
	            <div class="d-none d-lg-block @@cta_button_classes">
	                <a href="${path}/member/signIn.do" class="btn btn-md btn-outline-white animate-up-2 mr-3"><i class=""></i> <span class="d-xl-none">Docs</span> <span class="d-none d-xl-inline">로그인</span></a>
	                <a href="${path}/member/signUp.do" class="btn btn-md btn-secondary animate-up-2"><i class=""></i> 회원가입</a>
	            </div>
            </c:if>
            
            <c:if test="${loginMember != null}">
	            <div class="d-none d-lg-block @@cta_button_classes">${loginMember.name}</div>
	            <button onclick="location.href='<%=request.getContextPath()%>/member/마이페이지;'" class="d-none d-lg-block @@cta_button_classes">마이페이지</button>
	            <button onclick="location.replace('<%=request.getContextPath()%>/logout')" class="d-none d-lg-block @@cta_button_classes">로그아웃</button>
            </c:if>
        </div>
    </nav>
</header>
